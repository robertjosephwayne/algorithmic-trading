...
def deposit_history_supporting_network():
    return
...
def withdraw_history_supporting_network():
    return
...
def deposit_address_supporting_network():
    return
...
def account_api_trading_status_sapi():
    return
